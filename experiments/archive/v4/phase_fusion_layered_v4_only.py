...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Run V4 layered_fused only with matched budget.")
    parser.add_argument("--config", default="configs/phase_fusion_layered_v4_run100_match.yaml")
